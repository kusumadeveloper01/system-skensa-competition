<x-dashboard-layout>
    ...
    <div class="flex flex-row justify-between items-center">
        ...
        <a href="{{ route('admin.topic-category.create') }}"
    ...
    <div class="box-dashboard">
        <form class="flex flex-row  gap-2 items-center w-2/6" action="{{ route('admin.topic-category.index') }}"
            method="get">
            @csrf
                        ...
                        <tr>
                            ...
                            <td class="table-cell w-[20%]">
                                <div class="flex flex-row gap-3 items-center">
                                    <a class="text-blue-500" href="{{ route('admin.topic-category.show', $item->id) }}">
                                        <i class="text-base ri-eye-line text-text-secondary-color"></i>
                                    </a>
                                    <a class="text-blue-500" href="{{ route('admin.topic-category.edit', $item->id) }}">
                                        <i class="text-base ri-edit-line text-accent-color"></i>
                                    </a>
                                    <form action="{{ route('admin.topic-category.destroy', $item->id) }}" method="post"
