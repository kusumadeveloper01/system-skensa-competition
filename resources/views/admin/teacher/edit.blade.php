        ...
        <form action="#" method="POST"
            ...
            <div class="input-container">
                <div class="input-group">
                    ...
                    <x-input id="full_name" type="text" :disabled="false" name="full_name" value="Teacher Name"
                        placeholder="Enter full name..."></x-input>
                </div>
                <div class="input-group">
                    <x-label for="nip">NIP</x-label>
                    <x-input id="nip" type="text" :disabled="false" name="nip" value="198501012010011001"
                        placeholder="Enter NIP..."></x-input>
                </div>
                <div class="input-group">
                    <x-label for="email">Email</x-label>
                    <x-input id="email" type="email" :disabled="false" name="email" value="teacher@example.com"
