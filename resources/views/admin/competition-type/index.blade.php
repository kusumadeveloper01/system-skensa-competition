<x-dashboard-layout>
    ...
    <div class="flex flex-row justify-between items-center">
        <h1 class="page-title">Competition Type</h1>
        <a href="{{ route('admin.competition-type.create') }}"
    ...
    <div class="box-dashboard">
        <form class="flex flex-row  gap-2 items-center w-2/6" action="{{ route('admin.competition-type.index') }}"
            method="get">
            @csrf
